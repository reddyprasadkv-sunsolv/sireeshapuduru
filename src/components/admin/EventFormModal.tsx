        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group" style={{ marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginTop: '8px', flexWrap: 'wrap' }}>
              ...
              <button type="button" className="preset-chip" onClick={() => setFormData({ ...formData, banner: 'assets/images/workshop-1.png' })}>Retreat Hall (WS 1)</button>
              <button type="button" className="preset-chip" onClick={() => setFormData({ ...formData, banner: 'assets/images/workshop-2.png' })}>Mirror Work (WS 2)</button>

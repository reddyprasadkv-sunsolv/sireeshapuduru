        ...
        <div className="footer-grid">
          <div className="footer-col brand-col">
            ...
            <div className="footer-social-links">
              <a 
                href="https://www.facebook.com/sireeshapuduru1" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-icon-btn" 
                aria-label="Facebook Space"
                title="Follow Sireesha on Facebook"
              >
              ...
              <a 
                href="https://www.instagram.com/lifecoach_sireesha.puduru" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-icon-btn" 
                aria-label="Instagram Academy Space"
                title="Follow Sireesha on Instagram"
              >
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
              ...
              <a 
                href="https://www.youtube.com/@sireeshapuduru5533" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-icon-btn" 
                aria-label="YouTube Healing Guided Meditations"
              ...
              <a 
                href="https://www.linkedin.com/in/sireeshapuduru-selfloveandabundance/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-icon-btn" 
                aria-label="LinkedIn Executive Presence"
